...
--/****** Object:  StoredProcedure [dbo].[SP_FactContract_PART2]    Script Date: 6/27/2025 12:42:50 PM ******/
...
--** SSC-FDM-0007 - MISSING DEPENDENT OBJECTS "dw_safeguard.dbo.[Fact Contract]", "[DW_DATAACCESS].ep.[Fact Contract Earned Premium V Partition]", "[DW_DATAACCESS].ep.[Fact Contract Cancel Earned Premium V Partition]", "[DW_DATAACCESS].[dbo].[FACTCONTRACT_PART2_ONEDAYOLD]", "[DW_SAFEGUARD].dbo.[Fact Contract]", "[DW_SAFEGUARD].dbo.[dimension agent partner]", "[DW_SAFEGUARD].dbo.[Dimension Product]", "[DW_DATAACCESS].dbo.DateParameter", "[DW_SAFEGUARD].dbo.[Dimension Carrier]", "[DW_SAFEGUARD].dbo.[Fact Contract VPartition Claims]" **
...
$$
	DECLARE
		...
		ERR VARCHAR(2000) := SQLERRM /*** SSC-FDM-TS0023 - ERROR MESSAGE COULD BE DIFFERENT IN SNOWFLAKE ***/;
	BEGIN
		BEGIN
			BEGIN TRANSACTION;
			!!!RESOLVE EWI!!! /*** SSC-EWI-0040 - THE STATEMENT IS NOT SUPPORTED IN SNOWFLAKE ***/!!!
...
and f."Contract Sale Date Identifier" between :START_VALUE AND :END_VALUE;
			...
			-- added for Dimension Vehicle Details

			-----newly added 4 columns for cancellation on 16 Aug 2016

			INSERT INTO DW_DATAACCESS.dbo.FACTCONTRACT_PART2_ONEDAYOLD ("Fact Identifier", FunctionType, "Contract Number", "Contract Vin", "Contract Expiry Date Identifier", "Contract Dealer Cost", "Contract Dealer Remittance", "Contract Agent Cost", "Contract Customer Cost", "Contract System Generated Cost", "Contract Admin Fees", "Contract Net Admin Fees", "Contract Agent Commission", "Contract Net Agent Commission", "Secondary Agent Commission", "Contract Standard Premium", "Contract Written Premium", "Contract Net Premium", "Contract Cancellation Premium", "Contract Earned Premium", "Contract Cancel Date Identifier", "Contract Paid Cancel Indicator", "Contract Dealer Refund Amount", "Contract Customer Refund Amount", "Contract Form Number", "Contract Batch Date Identifier", "Source Contract Create Date", "Contract Batch Number", "Primary Sale Flag", "Contract Finance Amount", "Contract Stencil", "Weighted Contract Count", "Contract End VIN", "Contract Expiry Miles", "Contract InService Date", "Contract Lien Entity", "Contract Vehicle Cost", "Contract Vehicle Mileage", "Load Date", "Update Date", "Load By", "Updated By", "Vehicle Identifier", "Contract Status Identifier", "Contract Business Date Identifier", "Contract Sale Date Identifier", "Dealer Identifier", "Contract Channel Identifier", "Agent Partner Identifier", "Customer Identifier", "Contract Term Identifier", "Product Identifier", "Project Phase Identifier", "Contract Risk Type Identifier", "Vehicle Type Identifier", "Dealer Type Identifier", "Coverage Identifier", "Carrier Identifier", "Delete Flag", "Contract Locked Flag", "As of Yesterday Earned Premium", "As of Yesterday Claim Amount", "Dec Current Year Earned Premium", "Dec Current Year Claim Amount", "Nov Current Year Earned Premium", "Nov Current Year Claim Amount", "Oct Current Year Earned Premium", "Oct Current Year Claim Amount", "Sep Current Year Earned Premium", "Sep Current Year Claim Amount", "Aug Current Year Earned Premium", "Aug Current Year Claim Amount", "Jul Current Year Earned Premium", "Jul Current Year Claim Amount", "Jun Current Year Earned Premium", "Jun Current Year Claim Amount", "May Current Year Earned Premium", "May Current Year Claim Amount", "Apr Current Year Earned Premium", "Apr Current Year Claim Amount", "Mar Current Year Earned Premium", "Mar Current Year Claim Amount", "Feb Current Year Earned Premium", "Feb Current Year Claim Amount", "Jan Current Year Earned Premium", "Jan Current Year Claim Amount", "Dec Year-1 Earned Premium", "Nov Year-1 Earned Premium", "Oct Year-1 Earned Premium", "Sep Year-1 Earned Premium", "Aug Year-1 Earned Premium", "Jul Year-1 Earned Premium", "Jun Year-1 Earned Premium", "May Year-1 Earned Premium", "Apr Year-1 Earned Premium", "Mar Year-1 Earned Premium", "Feb Year-1 Earned Premium", "Jan Year-1 Earned Premium", "Current Year Last Quarter Earned Premium", "Current Year Last Quarter Claim Amount", "Current Year Third Quarter Earned Premium", "Current Year Third Quarter Claim Amount", "Current Year Second Quarter Earned Premium", "Current Year Second Quarter Claim Amount", "Current Year First Quarter Earned Premium", "Current Year First Quarter Claim Amount", "Year-1 Last Quarter Earned Premium", "Year-1 Last Quarter Claim Amount", "Year-1 Third Quarter Earned Premium", "Year-1 Third Quarter Claim Amount", "Year-1 Second Quarter Earned Premium", "Year-1 Second Quarter Claim Amount", "Year-1 First Quarter Earned Premium", "Year-1 First Quarter Claim Amount", "Year-2 Last Quarter Earned Premium", "Year-2 Last Quarter Claim Amount", "Year-2 Third Quarter Earned Premium", "Year-2 Third Quarter Claim Amount", "Year-2 Second Quarter Earned Premium", "Year-2 Second Quarter Claim Amount", "Year-2 First Quarter Earned Premium", "Year-2 First Quarter Claim Amount", "Last30 Days Contract Count", "Last90 Days Contract Count", "Year-3 Last Quarter Earned Premium", "Year-4 Last Quarter Earned Premium", "Year-5 Last Quarter Earned Premium", "Year-6 Last Quarter Earned Premium", "Claim Count", "Contract Original Business Date Identifier", "Cancel Paid Date", "Cancellation Fee", "Cancellation Reason", "Cancellation Percentage", "Contract Upsell Amount", "Contract Customer Cancel Date Identifier", "As Of Yesterday Claim Count", "Current Year First Quarter Claim Count", "Current Year Second Quarter Claim Count", "Current Year Third Quarter Claim Count", "Current Year Last Quarter Claim Count", "Year-1 First Quarter Claim Count", "Year-1 Second Quarter Claim Count", "Year-1 Third Quarter Claim Count", "Year-1 Last Quarter Claim Count", "Year-2 First Quarter Claim Count", "Year-2 Second Quarter Claim Count", "Year-2 Third Quarter Claim Count", "Year-2 Last Quarter Claim Count", "Jan Current Year Claim Count", "Feb Current Year Claim Count", "Mar Current Year Claim Count", "Apr Current Year Claim Count", "May Current Year Claim Count", "Jun Current Year Claim Count", "Jul Current Year Claim Count", "Aug Current Year Claim Count", "Sep Current Year Claim Count", "Oct Current Year Claim Count", "Nov Current Year Claim Count", "Dec Current Year Claim Count", "Future Cancellation Rate", "Retro Identifier", "As of Yesterday Net", "Jan Current Year Net", "Mar Current Year Net", "Apr Current Year Net", "May Current Year Net", "Jun Current Year Net", "Jul Current Year Net", "Feb Current Year Net", "Aug Current Year Net", "Sep Current Year Net", "Oct Current Year Net", "Nov Current Year Net", "Dec Current Year Net", "Current Year First Quarter Net", "Current Year Second Quarter Net", "Current Year Third Quarter Net", "Current Year Last Quarter Net", "Year-1 First Quarter Net", "Year-1 Second Quarter Net", "Year-1 Third Quarter Net", "Year-1 Last Quarter Net", "Year-2 First Quarter Net", "Year-2 Second Quarter Net", "Year-2 Third Quarter Net", "Year-2 Last Quarter Net", "Agent Code", "Gross Revenue", "Jan Current Year Written Premium", "Mar Current Year Written Premium", "Apr Current Year Written Premium", "May Current Year Written Premium", "Jun Current Year Written Premium", "Jul Current Year Written Premium", "Feb Current Year Written Premium", "Aug Current Year Written Premium", "Sep Current Year Written Premium", "Oct Current Year Written Premium", "Nov Current Year Written Premium", "Dec Current Year Written Premium", "Current Year First Quarter Written Premium", "Current Year Second Quarter Written Premium", "Current Year Third Quarter Written Premium", "Current Year Last Quarter Written Premium", "Jan Year-1 Written Premium", "Mar Year-1 Written Premium", "Apr Year-1 Written Premium", "May Year-1 Written Premium", "Jun Year-1 Written Premium", "Jul Year-1 Written Premium", "Feb Year-1 Written Premium", "Aug Year-1 Written Premium", "Sep Year-1 Written Premium", "Oct Year-1 Written Premium", "Nov Year-1 Written Premium", "Dec Year-1 Written Premium", "Year-1 First Quarter Written Premium", "Year-1 Second Quarter Written Premium", "Year-1 Third Quarter Written Premium", "Year-1 Last Quarter Written Premium", "Year-2 First Quarter Written Premium", "Year-2 Second Quarter Written Premium", "Year-2 Third Quarter Written Premium", "Year-2 Last Quarter Written Premium", "Year-3 Last Quarter Written Premium", "Year-4 Last Quarter Written Premium", "Year-5 Last Quarter Written Premium", "Year-6 Last Quarter Written Premium", "Jan Current Year Net Premium", "Mar Current Year Net Premium", "Apr Current Year Net Premium", "May Current Year Net Premium", "Jun Current Year Net Premium", "Jul Current Year Net Premium", "Feb Current Year Net Premium", "Aug Current Year Net Premium", "Sep Current Year Net Premium", "Oct Current Year Net Premium", "Nov Current Year Net Premium", "Dec Current Year Net Premium", "Current Year First Quarter Net Premium", "Current Year Second Quarter Net Premium", "Current Year Third Quarter Net Premium", "Current Year Last Quarter Net Premium", "Jan Year-1 Net Premium", "Mar Year-1 Net Premium", "Apr Year-1 Net Premium", "May Year-1 Net Premium", "Jun Year-1 Net Premium", "Jul Year-1 Net Premium", "Feb Year-1 Net Premium", "Aug Year-1 Net Premium", "Sep Year-1 Net Premium", "Oct Year-1 Net Premium", "Nov Year-1 Net Premium", "Dec Year-1 Net Premium", "Year-1 First Quarter Net Premium", "Year-1 Second Quarter Net Premium", "Year-1 Third Quarter Net Premium", "Year-1 Last Quarter Net Premium", "Year-2 First Quarter Net Premium", "Year-2 Second Quarter Net Premium", "Year-2 Third Quarter Net Premium", "Year-2 Last Quarter Net Premium", "Year-3 Last Quarter Net Premium", "Year-4 Last Quarter Net Premium", "Year-5 Last Quarter Net Premium", "Year-6 Last Quarter Net Premium", "As of Yesterday Cancel Earned Premium", "Dec Current Year Cancel Earned Premium", "Jan Current Year Cancel Earned Premium", "Feb Current Year Cancel Earned Premium", "Mar Current Year Cancel Earned Premium", "Apr Current Year Cancel Earned Premium", "May Current Year Cancel Earned Premium", "Jun Current Year Cancel Earned Premium", "Jul Current Year Cancel Earned Premium", "Aug Current Year Cancel Earned Premium", "Sep Current Year Cancel Earned Premium", "Oct Current Year Cancel Earned Premium", "Nov Current Year Cancel Earned Premium", "Jan Year-1 Cancel Earned Premium", "Feb Year-1 Cancel Earned Premium", "Mar Year-1 Cancel Earned Premium", "Apr Year-1 Cancel Earned Premium", "May Year-1 Cancel Earned Premium", "Jun Year-1 Cancel Earned Premium", "Jul Year-1 Cancel Earned Premium", "Aug Year-1 Cancel Earned Premium", "Sep Year-1 Cancel Earned Premium", "Oct Year-1 Cancel Earned Premium", "Nov Year-1 Cancel Earned Premium", "Dec Year-1 Cancel Earned Premium", "Current Year last Quarter Cancel Earned Premium", "Current Year Third Quarter Cancel Earned Premium", "Current Year Second Quarter Cancel Earned Premium", "Current Year First Quarter Cancel Earned Premium", "Year-1 Last Quarter Cancel Earned Premium", "Year-1 Third Quarter Cancel Earned Premium", "Year-1 Second Quarter Cancel Earned Premium", "Year-1 First Quarter Cancel Earned Premium", "Year-2 Last Quarter Cancel Earned Premium", "Year-2 Third Quarter Cancel Earned Premium", "Year-2 Second Quarter Cancel Earned Premium", "Year-2 First Quarter Cancel Earned Premium", "Current Year M01 In-force Contract Count", "Current Year M01 In-force Premium", "Current Year M02 In-force Contract Count", "Current Year M02 In-force Premium", "Current Year M03 In-force Contract Count", "Current Year M03 In-force Premium", "Current Year M04 In-force Contract Count", "Current Year M04 In-force Premium", "Current Year M05 In-force Contract Count", "Current Year M05 In-force Premium", "Current Year M06 In-force Contract Count", "Current Year M06 In-force Premium", "Current Year M07 In-force Contract Count", "Current Year M07 In-force Premium", "Current Year M08 In-force Contract Count", "Current Year M08 In-force Premium", "Current Year M09 In-force Contract Count", "Current Year M09 In-force Premium", "Current Year M10 In-force Contract Count", "Current Year M10 In-force Premium", "Current Year M11 In-force Contract Count", "Current Year M11 In-force Premium", "Current Year M12 In-force Contract Count", "Current Year M12 In-force Premium", "Year-1 M01 In-force Contract Count", "Year-1 M01 In-force Premium", "Year-1 M02 In-force Contract Count", "Year-1 M02 In-force Premium", "Year-1 M03 In-force Contract Count", "Year-1 M03 In-force Premium", "Year-1 M04 In-force Contract Count", "Year-1 M04 In-force Premium", "Year-1 M05 In-force Contract Count", "Year-1 M05 In-force Premium", "Year-1 M06 In-force Contract Count", "Year-1 M06 In-force Premium", "Year-1 M07 In-force Contract Count", "Year-1 M07 In-force Premium", "Year-1 M08 In-force Contract Count", "Year-1 M08 In-force Premium", "Year-1 M09 In-force Contract Count", "Year-1 M09 In-force Premium", "Year-1 M10 In-force Contract Count", "Year-1 M10 In-force Premium", "Year-1 M11 In-force Contract Count", "Year-1 M11 In-force Premium", "Year-1 M12 In-force Contract Count", "Year-1 M12 In-force Premium", "Current Year Q1 In-force Contract Count", "Current Year Q1 In-force Premium", "Current Year Q2 In-force Contract Count", "Current Year Q2 In-force Premium", "Current Year Q3 In-force Contract Count", "Current Year Q3 In-force Premium", "Current Year Q4 In-force Contract Count", "Current Year Q4 In-force Premium", "Year-1 Q1 In-force Contract Count", "Year-1 Q1 In-force Premium", "Year-1 Q2 In-force Contract Count", "Year-1 Q2 In-force Premium", "Year-1 Q3 In-force Contract Count", "Year-1 Q3 In-force Premium", "Year-1 Q4 In-force Contract Count", "Year-1 Q4 In-force Premium", "Year-2 Q1 In-force Contract Count", "Year-2 Q1 In-force Premium", "Year-2 Q2 In-force Contract Count", "Year-2 Q2 In-force Premium", "Year-2 Q3 In-force Contract Count", "Year-2 Q3 In-force Premium", "Year-2 Q4 In-force Contract Count", "Year-2 Q4 In-force Premium", "Contract Cleaned Dealer Commission", "Cancelled Revenue", "Net Contract Count", "Cancellation reason Identifier", "As Of yesterday Claim Amount New", "Jan Current Year Claim Amount New", "Feb Current Year Claim Amount New", "Mar Current Year Claim Amount New", "Apr Current Year Claim Amount New", "May Current Year Claim Amount New", "Jun Current Year Claim Amount New", "Jul Current Year Claim Amount New", "Aug Current Year Claim Amount New", "Sep Current Year Claim Amount New", "Oct Current Year Claim Amount New", "Nov Current Year Claim Amount New", "Dec Current Year Claim Amount New", "Current Year First Quarter Claim Amount New", "Current Year Second Quarter Claim Amount New", "Current Year Third Quarter Claim Amount New", "Current Year Last Quarter Claim Amount New", "Current Year First Quarter Claim Count New", "Current Year Second Quarter Claim Count New", "Current Year Third Quarter Claim Count New", "Current Year Last Quarter Claim Count New", "Year-1 First Quarter Claim Amount New", "Year-1 Second Quarter Claim Amount New", "Year-1 Third Quarter Claim Amount New", "Year-1 Last Quarter Claim Amount New", "Year-2 First Quarter Claim Amount New", "Year-2 Second Quarter Claim Amount New", "Year-2 Third Quarter Claim Amount New", "Year-2 Last Quarter Claim Amount New", "Year-3 Last Quarter Claim Amount New", "Year-4 Last Quarter Claim Amount New", "Year-5 Last Quarter Claim Amount New", "Year-6 Last Quarter Claim Amount New", "Jan Year-1 Claim Amount New", "Feb Year-1 Claim Amount New", "Mar Year-1 Claim Amount New", "Apr Year-1 Claim Amount New", "May Year-1 Claim Amount New", "Jun Year-1 Claim Amount New", "Jul Year-1 Claim Amount New", "Aug Year-1 Claim Amount New", "Sep Year-1 Claim Amount New", "Oct Year-1 Claim Amount New", "Nov Year-1 Claim Amount New", "Dec Year-1 Claim Amount New", "Contract Activity Max Locked Date Identifier", "Contract Activity Min Locked Date Identifier", "Cancel Paid Date Identifier", "As Of Yesterday Claim Count New", "Jan Current Year Claim Count New", "Feb Current Year Claim Count New", "Mar Current Year Claim Count New", "Apr Current Year Claim Count New", "May Current Year Claim Count New", "Jun Current Year Claim Count New", "Jul Current Year Claim Count New", "Aug Current Year Claim Count New", "Sep Current Year Claim Count New", "Oct Current Year Claim Count New", "Nov Current Year Claim Count New", "Dec Current Year Claim Count New", "Year-1 First Quarter Claim Count New", "Year-1 Second Quarter Claim Count New", "Year-1 Third Quarter Claim Count New", "Year-1 Last Quarter Claim Count New", "Year-2 First Quarter Claim Count New", "Year-2 Second Quarter Claim Count New", "Year-2 Third Quarter Claim Count New", "Year-2 Last Quarter Claim Count New", "Jan Year-1 Claim Count New", "Feb Year-1 Claim Count New", "Mar Year-1 Claim Count New", "Apr Year-1 Claim Count New", "May Year-1 Claim Count New", "Jun Year-1 Claim Count New", "Jul Year-1 Claim Count New", "Aug Year-1 Claim Count New", "Sep Year-1 Claim Count New", "Oct Year-1 Claim Count New", "Nov Year-1 Claim Count New", "Dec Year-1 Claim Count New", "Form Deductible Amount", "Vehicle Detail Identifier", CAN_Dealer_HST_GST, CAN_Dealer_PST, CAN_Dealer_QST, CAN_Customer_HST_GST, CAN_Customer_PST, CAN_Customer_QST, CON_Dealer_HST_GST, CON_Dealer_PST, CON_Dealer_QST, CON_Customer_HST_GST, CON_Customer_PST, CON_Customer_QST, "TW Identifier", "Contract Release Date Identifier", "Rate System Identifier", "Year-3 Last Quarter Cancel Earned Premium", "Year-4 Last Quarter Cancel Earned Premium", "Year-5 Last Quarter Cancel Earned Premium", "Year-6 Last Quarter Cancel Earned Premium", "Contract Batch Identifier", "Contract Create Date Identifier", "Batch Create Date Identifier", "Original Contract Number", "Contract EAS Info Identifier")
...
and "Contract Sale Date Identifier" between :START_VALUE AND :END_VALUE;
		...
		EXCEPTION
			WHEN OTHER THEN
IF (:TRANCOUNT >0) THEN
					!!!RESOLVE EWI!!! /*** SSC-EWI-0073 - PENDING FUNCTIONAL EQUIVALENCE REVIEW FOR 'ROLLBACK' NODE ***/!!!
					ROLLBACK
END IF;
 
--** SSC-FDM-TS0019 - RAISERROR ERROR MESSAGE MAY DIFFER BECAUSE OF THE SQL SERVER STRING FORMAT **
SELECT
					RAISERROR_UDF(50050, 11, 1, array_construct('SP_FactContract_PART2', :ERR));
		END;
	END;
$$;